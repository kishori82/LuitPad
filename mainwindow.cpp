...
extern int validSoftware =0;
QHash<QString, unsigned int> hardDiskIDs;
QHash<QString, unsigned int> hardDiskIDs2;
...
*/
    ...
    hardDiskIDs.insert("89OrVqSLTSZrH6Sk0EeX6Xv5aJU=",1);
    hardDiskIDs.insert("TXicQszT9RwPLk18/kY1r0YbLFk=",1);
    hardDiskIDs.insert("cHQbKkx0HMKV5O3ZIqCcRhR0Dmc=",1);
    hardDiskIDs.insert("qQgL0jQdNO520S9F5RnuGqsWSeo=",1);
    hardDiskIDs.insert("MFe9dGEI4v49JlgnoczykZ9NjVg=",1);
    hardDiskIDs.insert("iEFgUhZhfq3e7vYQMjYPncQWQzY=",1);
    hardDiskIDs.insert("3OxqN16veb9sZPdHBd4ZRJhrQHo=",1);
    hardDiskIDs.insert("MI/lYIS66lWfv7CCDw3jHrerFuM=",1);
    hardDiskIDs.insert("hx/Trc/pgizxladQyPPKxWaAUus=",1);
    hardDiskIDs.insert("a2rqdo4vTmrLZ8zfGpCH+IdTdbQ=",1);
    hardDiskIDs.insert("7pH8wLK2/qfSOj8a1ex4kcgHh2Q=",1);
    hardDiskIDs.insert("/TgAmP8OWLVReWRp/5XtxdVOJuo=",1);
    hardDiskIDs.insert("4WGJIzuNIldyH9WXBxYNZOxbM9I=",1);
    hardDiskIDs.insert("oFyWM+UFz8OYEq4TKvZDwHLWJ6Q=",1);
    hardDiskIDs.insert("z4gKEEcDsdEMgZfe0zhjRmVvO3E=",1);
    hardDiskIDs.insert("AmPoa8gQ+qVMp12HzK0yT41lRrc=",1);
    hardDiskIDs.insert("IF/hSwokvFy40aVGAc+5AZWR46U=",1);
    hardDiskIDs.insert("vxYz6qQToECDcdYKKE6diUaC8Kw=",1);
    hardDiskIDs.insert("R3IvoC+8ABlzNwiRUIgyRozaR4w=",1);
    hardDiskIDs.insert("25EoV20yk2FgQzz7EtFaadzcj7E=",1);

    hardDiskIDs.insert("1+Tj7eG28ZlRnZMURjvar1m2N8E=",1);
    hardDiskIDs.insert("HHiMP1TIoOoxa3zHJboilx7qZzg=",1);
    hardDiskIDs.insert("KsA0pj6FMUznzPkUaJ0VVs+VZ3A=",1);
    hardDiskIDs.insert("ywZTrAgr5bwVJm5KZIbzJGnDSTc=",1);
    hardDiskIDs.insert("YB2bCU18HfPtcRyXrmURmumPI3w=",1);
    hardDiskIDs.insert("uy+j7nr7n1TG37XQIfFLH/5AwWM=",1);
    hardDiskIDs.insert("Y8dbxBje0vptBpfqHM0OnzeBq54=",1);

    hardDiskIDs.insert("cJDob61ziAEBypnVwV0SZrdYSZI=",1);
    hardDiskIDs.insert("JB0Vzf/46S12lEBmqLEMZEp5hs0=",1);
    hardDiskIDs.insert("AJYVlNNnWACrbopuytFoLynfMbc=",1);
    hardDiskIDs.insert("uy+j7nr7n1TG37XQIfFLH/5AwWM=",1);
    hardDiskIDs.insert("7MirSj042EP1qREve82wgWZAwu8=",1);
    hardDiskIDs.insert("s1DRWeujrrIgfYY4blyuC+gB8s4=",1);
    hardDiskIDs.insert("s1DRWeujrrIgfYY4blyuC+gB8s4=",1);
    hardDiskIDs.insert("AJYVlNNnWACrbopuytFoLynfMbc=",1);
    hardDiskIDs.insert("3luoW0f8tYV4Mq64z2uVUkIEZ0g=",1);
    hardDiskIDs.insert("fKGrbZv+NUsXU3UBi5UcGaRGiHU=",1);
    hardDiskIDs.insert("woWOMzVe6BZJUth/pL9BYf7WUVc=",1);
    hardDiskIDs.insert("tl+oOC3MdrhQqW9d2Ljj+hw4lyk=",1);
    hardDiskIDs.insert("zt6TfUAgJbwXFSXNhD2uNFfdxJY=",1);
    hardDiskIDs.insert("1HWijdeWq3a4lQsWrL+bQ8p6fUQ=",1);


    hardDiskIDs.insert("1JyGRZxxVPPVDUYh/Ht6HoFVCmE=",1);
    hardDiskIDs.insert("mXvBKphRHTzWtp3NpTYrpnMnZsI=",1);
    hardDiskIDs.insert("votN0mxZP4jFkPqBFdtY2o8a1ic=",1);
    hardDiskIDs.insert("rSOi/FbxjK+Zbgcvm5azdcm6eiU=",1);
    hardDiskIDs.insert("LDmAGOm/h+Wcfg5/AcpjL6HEdqI=",1);
    hardDiskIDs.insert("yl53Y0oyd1/xhFSq5lfbvBNueW4=",1);
    hardDiskIDs.insert("XcHpJ0t+Kk0h8dOwHkuBq/wvFMg=",1);
    hardDiskIDs.insert("rplSG5mejfJj6z+r5CmdUv7dLFc=",1);
    hardDiskIDs.insert("euHQHL5yVunldz0XBcp9jGbqtO4=",1);
    hardDiskIDs.insert("/rDxgAveL2RzViMwZoodTuelsaI=",1);
    hardDiskIDs.insert("++3jB0RLb9HTixHV/CjEb5Esk2g=",1);
    hardDiskIDs.insert("APTMXlTyzFYNSEbMdasQddw+Wj0=",1);
    hardDiskIDs.insert("Dn1+/ixf2tpNGi8WCXoXhKSJ8RI=",1);

    hardDiskIDs.insert("EkfijXEFcNmaHLvfI0eqw6SZlHw=",1);
    hardDiskIDs.insert("zaD6t08beuN5p+dq/Yzx83GOQuU=",1);
    hardDiskIDs.insert("/IfZt24CSprfgj7Az98gJIOggjk=",1);
    hardDiskIDs.insert("M7cq01tOr67y2xJeOAkqKflrFs0=",1);
    hardDiskIDs.insert("xrykA2XgjxfVQ+l+GyVV5ryuQyQ=",1);
    hardDiskIDs.insert("ZPTXkxuFkeAfRU0idesh1YZbWaE=",1);
    hardDiskIDs.insert("DMhLsCFzTw1ZYqLteHDaQOCFmDA=",1);
    hardDiskIDs.insert("oLKkkVv1LMsRHrvIK9+qq4qne/8=",1);

    hardDiskIDs.insert("ew/dXX1/1wnxMCCEZL5y3hslFkw=",1);
    hardDiskIDs.insert("yYohFSQPTxcpj2kdmipYSwXUMr4=",1);
    hardDiskIDs.insert("jSFMdEDkwU2QKZy40+apd9PH8TA=",1);
    hardDiskIDs.insert("6Lc4Nr+huDd4t92G+dqLhaNQ3kk=",1);
    hardDiskIDs.insert("3Z2jxloYnGdk/8P69jt+5XG0Kyk=",1);
    hardDiskIDs.insert("M8bWmF9i/JhSg07qv+N4ezEbTso=",1);
    hardDiskIDs.insert("zfgTwdq/BS3hGNdueqhUH7voAXw=",1);
    hardDiskIDs.insert("zOMzgppq3gZbaUNu0QZAFE35f4k=",1);
    hardDiskIDs.insert("zD7LoBzkQLwyfvcwRhPad4TxTVU=",1);
    hardDiskIDs.insert("rpL6MLSX+LuVmnsgJajMMKf5QL8=",1);
    hardDiskIDs.insert("SCjRpcTDNH/WEMzSE9kc8WMUYVo=",1);
    hardDiskIDs.insert("x7SJ2TJNE7RFnOkB3zo56uux8QQ=",1);
    hardDiskIDs.insert("uy+j7nr7n1TG37XQIfFLH/5AwWM=",1);
    hardDiskIDs.insert("0NpeDae5m4cGdHPH6BCo6kfLNhY=",1);
    hardDiskIDs.insert("HZFSMbmOxIdnGtNGMxKU4DCcoxw=",1);
    ...
    hardDiskIDs.insert("GCOe4qHa0gkFDKcor2q7SirYUCw=",1);  //nava Feb 20 2013
    // new format
 //   hardDiskIDs.insert("Zk67LT3Wo7hZSCBi93LN/ndlzdo=",1); hardDiskIDs.insert("AudZ29qPFbRdVAU2Qi/BwxqN7Wo=",1);  //cpustring "tn7GhE8TVqfgqu77ZuokhoCyy3s="



//    validSoftware++;
    /*
    qDebug() << mac_adressList;
    qDebug() << cpuinfo_string;


    qDebug() << "Get stored key " << getStoredKey();
*/

    getStoredKeys(storedKeys);

    foreach(QString macaddr, mac_adressList ) {
        if(macaddr.size() > 0 && storedKeys.contains(macaddr)) {
            validSoftware++;
            //piratedCopy(mesg);
        }
    }
    ...
    foreach(QString macaddr, mac_adressList ) {
        if(macaddr.size() > 0 && hardDiskIDs.contains(macaddr)) {
            validSoftware++;
            //piratedCopy(mesg);
        }
    }
...
{
    if( validSoftware==0 && type ==NEW) type = TRIAL;
...
void MainWindow::registerKey() {
    if( validSoftware ) {
        Utilities::warningBox("         This product is already registered!\n                             Or    \n A valid USB key is already plugged into the computer!");
        return;
    }

    registerbox.clearKey();
    registerbox.show();
...
*/
    ...
    //saveAsHtmlAct ->setShortcut(QKeySequence::QKeySequence(Qt::Key_Control + Qt::Key_H));
     ...
     registerAct = new QAction( tr("&Enter Registration Key"), this);
     registerAct->setStatusTip(tr("Enter Registration Key"));
     connect(registerAct, SIGNAL(triggered()), this, SLOT(registerKey()));
}
...
//    editMenu->addAction(f3Act);
   ...
   // connect(settingsMenu, SIGNAL(aboutToShow()), this, SLOT(updateSettingsMenu()));
    ...
    registerMenu->addAction(registerAct);
...
void  MainWindow::piratedCopy(QString mesg)
 {
    Utilities::warningBox("Invalid LuitPad copy for your computer\n Going to close the application!\n Please contact the software vendor at luitpad@gmail.com\n" + mesg);
    exit(0);
 }
