...
void Profile::display() {
  ...
  if (kbd == NULL || !kbd->isVisible()) {
    ...
    // kbd->setSizePolicy( QSizePolicy( QSizePolicy::Fixed, QSizePolicy::Fixed,
    // TRUE ));
...
void Profile::setModifierOrder(bool flag) { modifierOrder = flag; }
...
void Profile::deSign() {
  ...
  //  modifierOrderCheckbox = new QCheckBox( QString(QChar(0x9c7)) +QString("/")
  //  + QChar(0x9c8)+QString("/") + QChar(0x9bf) + " order change", this);
  ...
  // connect(modifierOrderCheckbox,
  // SIGNAL(stateChanged(int)),this,SLOT(changeModifierOrder(int)));
...
*/
  ...
  int width = 45;
  int height = 35;
  QToolButton *ka = new QToolButton(this);
  ka->setStyleSheet(fontstyle);
  ka->setText(trUtf8("ক"));
  ka->setFixedSize(width, height);
  QToolButton *kha = new QToolButton(this);
  kha->setStyleSheet(fontstyle);
  kha->setText(trUtf8("খ"));
  kha->setFixedSize(width, height);
  QToolButton *ga = new QToolButton(this);
  ga->setStyleSheet(fontstyle);
  ga->setText(trUtf8("গ"));
  ga->setFixedSize(width, height);
  QToolButton *gha = new QToolButton(this);
  gha->setStyleSheet(fontstyle);
  gha->setText(trUtf8("ঘ"));
  gha->setFixedSize(width, height);
  QToolButton *nga = new QToolButton(this);
  nga->setStyleSheet(fontstyle);
  nga->setText(trUtf8("ঙ"));
  nga->setFixedSize(width, height);

  QToolButton *ca = new QToolButton(this);
  ca->setStyleSheet(fontstyle);
  ca->setText(trUtf8("চ"));
  ca->setFixedSize(width, height);
  QToolButton *cha = new QToolButton(this);
  cha->setStyleSheet(fontstyle);
  cha->setText(trUtf8("ছ"));
  cha->setFixedSize(width, height);
  QToolButton *ja = new QToolButton(this);
  ja->setStyleSheet(fontstyle);
  ja->setText(trUtf8("জ"));
  ja->setFixedSize(width, height);
  QToolButton *jha = new QToolButton(this);
  jha->setStyleSheet(fontstyle);
  jha->setText(trUtf8("ঝ"));
  jha->setFixedSize(width, height);
  QToolButton *nya = new QToolButton(this);
  nya->setStyleSheet(fontstyle);
  nya->setText(trUtf8("ঞ"));
  nya->setFixedSize(width, height);

  QToolButton *ta = new QToolButton(this);
  ta->setStyleSheet(fontstyle);
  ta->setText(trUtf8("ত"));
  ta->setFixedSize(width, height);
  QToolButton *tha = new QToolButton(this);
  tha->setStyleSheet(fontstyle);
  tha->setText(QChar(0x9A5));
  tha->setFixedSize(width, height);
  //  QToolButton *tha = new QToolButton(this); tha->setText("tha");
  //  tha->setFixedSize(30, 20);
  QToolButton *da = new QToolButton(this);
  da->setStyleSheet(fontstyle);
  da->setText(trUtf8("দ"));
  da->setFixedSize(width, height);
  QToolButton *dha = new QToolButton(this);
  dha->setStyleSheet(fontstyle);
  dha->setText(trUtf8("ধ"));
  dha->setFixedSize(width, height);
  QToolButton *na = new QToolButton(this);
  na->setStyleSheet(fontstyle);
  na->setText(trUtf8("ন"));
  na->setFixedSize(width, height);

  QToolButton *Ta = new QToolButton(this);
  Ta->setStyleSheet(fontstyle);
  Ta->setText(trUtf8("ট"));
  Ta->setFixedSize(width, height);
  // QToolButton *Tha = new QToolButton(this); Tha->setText(trUtf8("� "));
  // Tha->setFixedSize(30, 20);
  QToolButton *Tha = new QToolButton(this);
  Tha->setStyleSheet(fontstyle);
  Tha->setText(QChar(0x9A0));
  Tha->setFixedSize(width, height);
  QToolButton *Da = new QToolButton(this);
  Da->setStyleSheet(fontstyle);
  Da->setText(trUtf8("ড"));
  ...
  QToolButton *pa = new QToolButton(this);
  pa->setStyleSheet(fontstyle);
  pa->setText(trUtf8("প"));
  pa->setFixedSize(width, height);
  QToolButton *pha = new QToolButton(this);
  pha->setStyleSheet(fontstyle);
  pha->setText(trUtf8("ফ"));
  pha->setFixedSize(width, height);
  QToolButton *ba = new QToolButton(this);
  ba->setStyleSheet(fontstyle);
  ba->setText(trUtf8("ব"));
  ba->setFixedSize(width, height);
  QToolButton *bha = new QToolButton(this);
  bha->setStyleSheet(fontstyle);
  bha->setText(trUtf8("ভ"));
  bha->setFixedSize(width, height);
  QToolButton *ma = new QToolButton(this);
  ma->setStyleSheet(fontstyle);
  ma->setText(trUtf8("ম"));
  ma->setFixedSize(width, height);

  QToolButton *Ja = new QToolButton(this);
  Ja->setStyleSheet(fontstyle);
  Ja->setText(trUtf8("য"));
  Ja->setFixedSize(width, height);
  QToolButton *ra = new QToolButton(this);
  ra->setStyleSheet(fontstyle);
  ra->setText(trUtf8("ৰ"));
  ra->setFixedSize(width, height);
  QToolButton *la = new QToolButton(this);
  la->setStyleSheet(fontstyle);
  la->setText(trUtf8("ল"));
  la->setFixedSize(width, height);
  QToolButton *wa = new QToolButton(this);
  wa->setStyleSheet(fontstyle);
  wa->setText(trUtf8("ৱ"));
  wa->setFixedSize(width, height);

  QToolButton *Sa = new QToolButton(this);
  Sa->setStyleSheet(fontstyle);
  Sa->setText(trUtf8("শ"));
  Sa->setFixedSize(width, height);
  QToolButton *sha = new QToolButton(this);
  sha->setStyleSheet(fontstyle);
  sha->setText(trUtf8("ষ"));
  sha->setFixedSize(width, height);
  QToolButton *sa = new QToolButton(this);
  sa->setStyleSheet(fontstyle);
  sa->setText(trUtf8("স"));
  sa->setFixedSize(width, height);
  QToolButton *ha = new QToolButton(this);
  ha->setStyleSheet(fontstyle);
  ha->setText(trUtf8("হ"));
  ha->setFixedSize(width, height);

  QToolButton *khya = new QToolButton(this);
  khya->setStyleSheet(fontstyle);
  khya->setText(trUtf8("ক্ষ"));
  khya->setFixedSize(width, height);
  QToolButton *drr = new QToolButton(this);
  drr->setStyleSheet(fontstyle);
  drr->setText(trUtf8("ড়"));
  drr->setFixedSize(width, height);
  QToolButton *arr = new QToolButton(this);
  arr->setStyleSheet(fontstyle);
  arr->setText(trUtf8("ঢ়"));
  arr->setFixedSize(width, height);
  QToolButton *ya = new QToolButton(this);
  ya->setStyleSheet(fontstyle);
  ya->setText(trUtf8("য়"));
  ya->setFixedSize(width, height);

  QToolButton *cbindu = new QToolButton(this);
  cbindu->setStyleSheet(fontstyle);
  cbindu->setText(trUtf8("ঁ"));
  cbindu->setFixedSize(width, height);
  QToolButton *bjnt = new QToolButton(this);
  bjnt->setStyleSheet(fontstyle);
  bjnt->setText(QChar(0x9ce));
  bjnt->setFixedSize(width, height);
  QToolButton *ansr = new QToolButton(this);
  ansr->setStyleSheet(fontstyle);
  ansr->setText(trUtf8("ং"));
  ansr->setFixedSize(width, height);
  QToolButton *bsrg = new QToolButton(this);
  bsrg->setStyleSheet(fontstyle);
  bsrg->setText(trUtf8("ঃ"));
  bsrg->setFixedSize(width, height);

  QToolButton *a = new QToolButton(this);
  a->setStyleSheet(fontstyle);
  a->setText(trUtf8("অ"));
  a->setFixedSize(width, height);
  QToolButton *aa = new QToolButton(this);
  aa->setStyleSheet(fontstyle);
  aa->setText(trUtf8("আ"));
  aa->setFixedSize(width, height);
  QToolButton *i = new QToolButton(this);
  i->setStyleSheet(fontstyle);
  i->setText(trUtf8("ই"));
  i->setFixedSize(width, height);
  QToolButton *ii = new QToolButton(this);
  ii->setStyleSheet(fontstyle);
  ii->setText(trUtf8("ঈ"));
  ii->setFixedSize(width, height);

  QToolButton *u = new QToolButton(this);
  u->setStyleSheet(fontstyle);
  u->setText(trUtf8("উ"));
  u->setFixedSize(width, height);
  QToolButton *uu = new QToolButton(this);
  uu->setStyleSheet(fontstyle);
  uu->setText(trUtf8("ঊ"));
  uu->setFixedSize(width, height);
  QToolButton *ri = new QToolButton(this);
  ri->setStyleSheet(fontstyle);
  ri->setText(trUtf8("ঋ"));
  ri->setFixedSize(width, height);

  QToolButton *e = new QToolButton(this);
  e->setStyleSheet(fontstyle);
  e->setText(QChar(0x98f));
  e->setFixedSize(width, height);
  QToolButton *ei = new QToolButton(this);
  ei->setStyleSheet(fontstyle);
  ei->setText(QChar(0x990));
  ei->setFixedSize(width, height);
  QToolButton *o = new QToolButton(this);
  o->setStyleSheet(fontstyle);
  o->setText(QChar(0x993));
  o->setFixedSize(width, height);
  QToolButton *ou = new QToolButton(this);
  ou->setStyleSheet(fontstyle);
  ou->setText(QChar(0x994));
  ou->setFixedSize(width, height);

  QToolButton *dlink = new QToolButton(this);
  dlink->setStyleSheet(fontstyle);
  dlink->setText(trUtf8("্"));
  dlink->setFixedSize(width, height);
  QToolButton *aa_matra = new QToolButton(this);
  aa_matra->setText(trUtf8("া"));
  aa_matra->setFixedSize(width, height);
  QToolButton *i_matra = new QToolButton(this);
  i_matra->setText(trUtf8("ি"));
  i_matra->setFixedSize(width, height);
  QToolButton *ii_matra = new QToolButton(this);
  ii_matra->setText(trUtf8("ী"));
  ii_matra->setFixedSize(width, height);

  QToolButton *u_matra = new QToolButton(this);
  u_matra->setText(trUtf8("ু"));
  u_matra->setFixedSize(width, height);
  QToolButton *uu_matra = new QToolButton(this);
  uu_matra->setText(trUtf8("ূ"));
  uu_matra->setFixedSize(width, height);
  QToolButton *ri_matra = new QToolButton(this);
  ri_matra->setText(trUtf8("ৃ"));
  ri_matra->setFixedSize(width, height);

  QToolButton *e_matra = new QToolButton(this);
  e_matra->setText(trUtf8("ে"));
  e_matra->setFixedSize(width, height);
  QToolButton *ei_matra = new QToolButton(this);
  ei_matra->setText(trUtf8("ৈ"));
  ei_matra->setFixedSize(width, height);
  QToolButton *o_matra = new QToolButton(this);
  o_matra->setText(trUtf8("ো"));
  o_matra->setFixedSize(width, height);
  QToolButton *ou_matra = new QToolButton(this);
  ou_matra->setText(trUtf8("ৌ"));
  ou_matra->setFixedSize(width, height);
  //=======================================================================
  ...
  connect(profCombo, SIGNAL(currentIndexChanged(QString)), this,
          SLOT(fill_keyboard(QString)));
...
bool Profile::deleteProfile() {
  ...
  if (!Utilities::YesNoDialog(QString("The deleted profile with be lost."),
                              QString("Do you want to want to delete it?"))) {
    return false;
  }
  ...
  QString fname = QLatin1String("profile") + QDir::separator() +
                  profCombo->currentText() + QLatin1String(".dat");
...
bool Profile::saveProfile() {
  ...
  if (profCombo->currentText().toUpper() == QString("DEFAULT")) {
    Utilities::warningBox(
        "Profile DEFAULT cannot be changed. Pick another profile name.");
    return false;
  }

  if (!Utilities::YesNoDialog(
          QString("If you save previous mapping will be overwritten."),
  ...
  QString fn = QLatin1String("profile") + QDir::separator() +
               profCombo->currentText() + QLatin1String(".dat");
  ...
  if (!outFile.isOpen()) {
    ...
    outText = QString("<char>\t") + QString("0x9950x9CD0x9B7\t") +
              lbl[34]->text() + "\n";
    outStream << outText + "\n";
    ...
    /*
                outText =  QString("<char>\t") + QString("0x986\t") +
       lbl[43]->text()+"\n"; outStream << outText) + "\n"; outText =
       QString("<char>\t") + QString("0x987\t") +  lbl[44]->text()+"\n";
       outStream << outText) + "\n"; outText =  QString("<char>\t") +
       QString("0x988\t") +  lbl[45]->text()+"\n"; outStream << outText) + "\n";

                outText =  QString("<char>\t") + QString("0x989\t") +
       lbl[46]->text()+"\n"; outStream << outText) + "\n"; outText =
       QString("<char>\t") + QString("0x98A\t") +  lbl[47]->text()+"\n";
       outStream << outText) + "\n"; outText =  QString("<char>\t") +
       QString("0x98B\t") +  lbl[48]->text()+"\n"; outStream << outText) + "\n";

                outText =  QString("<char>\t") + QString("0x98F\t") +
       lbl[49]->text()+"\n"; outStream << outText) + "\n"; outText =
       QString("<char>\t") + QString("0x990\t") +  lbl[50]->text()+"\n";
       outStream << outText) + "\n"; outText =  QString("<char>\t") +
       QString("0x993\t") +  lbl[51]->text()+"\n"; outStream << outText) + "\n";
                outText =  QString("<char>\t") + QString("0x994\t") +
       lbl[52]->text()+"\n"; outStream << outText) + "\n";
      */
    ...
    outText = QString("<vowelmodifier_order>\t") +
              (this->modifierOrder ? "true" : "false") + "\n";
    outStream << outText + "\n";
  ...
  Utilities::warningBox("Saved the profile " +
                        profCombo->currentText().toUpper() + " in " + fn);
  return true;
}
...
bool Profile::fill_keyboard(const QString &profName) {
  // SimpleCrypt *crypto =
  // SimpleCrypt::getEncryptor(Q_UINT64_C(0x23bacf02473fdea0));
  if (profName.length() == 0)
    return false;
...
*/
void Profile::setChangeEnable() { changeEnDisableFlag = true; }

void Profile::setChangeDisable() { changeEnDisableFlag = false; }

bool Profile::isChangeEnable() { return changeEnDisableFlag; }
