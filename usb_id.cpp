...
// USB_ID_5.cpp : Defines the entry point for the console application.
//
...
int ReadDrivePortsInWin9X (void)
{
   ...
   if (VxDHandle != INVALID_HANDLE_VALUE)
   {
      ...
      CloseHandle (VxDHandle);
        ...
        //qDebug() << "ERROR: Could not open IDE21201.VXD file";
